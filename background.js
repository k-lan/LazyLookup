...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === "translateText") {
    ...
    explainWord(request.word, request.sentence, request.language, request.languageResponse, request.languageAbility)
